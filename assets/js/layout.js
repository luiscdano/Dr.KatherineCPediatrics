(function () {
  ...
  function bookingUrl() {
    return String(data.clinic.onlineAppointmentsUrl || "https://ff.healthatom.io/PXoRpm").trim();
  }

  function syncBookingLinks() {
    document.querySelectorAll("[data-online-appointments-link]").forEach(function (link) {
  ...
  if (footerHost) {
    footerHost.innerHTML =
      ...
      "      </ul>" +
      '      <a class="btn btn-secondary footer-hours-cta" href="' + bookingUrl() + '" target="_blank" rel="noopener noreferrer" data-online-appointments-link="true"><span class="footer-hours-cta-label" data-i18n-key="layout.footer.onlineAppointments">' + tk("layout.footer.onlineAppointments", "Citas en líneas") + "</span></a>" +
      "    </section>" +
      "  </div>" +
