(function () {
  ...
  if (footerHost) {
    footerHost.innerHTML =
      ...
      "      </ul>" +
      '      <a class="btn btn-secondary footer-hours-cta" href="' + bookingUrl() + '" data-online-appointments-link="true" data-i18n-key="layout.footer.onlineAppointments">' + tk("layout.footer.onlineAppointments", "Citas en líneas") + "</a>" +
      "    </section>" +
      "  </div>" +
